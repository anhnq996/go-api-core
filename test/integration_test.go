...
func TestUserAPI_Integration(t *testing.T) {
	...
	t.Run("Create User", func(t *testing.T) {
		...
		req := CreateAuthenticatedRequest(t, jwtManager, "POST", "/api/v1/users", userData, "admin-123", "admin", "admin@example.com")
	...
	t.Run("Get Users List", func(t *testing.T) {
		req := CreateAuthenticatedRequest(t, jwtManager, "GET", "/api/v1/users", nil, "admin-123", "admin", "admin@example.com")
		w := httptest.NewRecorder()
	...
	t.Run("Get Specific User", func(t *testing.T) {
		...
		createReq := CreateAuthenticatedRequest(t, jwtManager, "POST", "/api/v1/users", userData, "admin-123", "admin", "admin@example.com")
		...
		// Now get the user
		req := CreateAuthenticatedRequest(t, jwtManager, "GET", "/api/v1/users/"+userID, nil, "admin-123", "admin", "admin@example.com")
		w := httptest.NewRecorder()
	...
	t.Run("Update User", func(t *testing.T) {
		...
		req := CreateAuthenticatedRequest(t, jwtManager, "PUT", "/api/v1/users/"+userID, updateData, "admin-123", "admin", "admin@example.com")
		w := httptest.NewRecorder()
	...
	t.Run("Delete User", func(t *testing.T) {
		...
		// Delete the user
		req := CreateAuthenticatedRequest(t, jwtManager, "DELETE", "/api/v1/users/"+userID, nil, "admin-123", "admin", "admin@example.com")
		w := httptest.NewRecorder()
...
func TestUserAPI_Authentication(t *testing.T) {
	...
	t.Run("Unauthorized Request", func(t *testing.T) {
		req := CreateTestRequest("GET", "/api/v1/users", nil)
		w := httptest.NewRecorder()
...
func TestUserAPI_Validation(t *testing.T) {
	...
	t.Run("Duplicate Email", func(t *testing.T) {
		...
		req := CreateAuthenticatedRequest(t, jwtManager, "POST", "/api/v1/users", duplicateData, "admin-123", "admin", "admin@example.com")
		w := httptest.NewRecorder()
